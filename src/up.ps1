...
dotnet sitecore login --cm https://cm.altudohackathon.localhost/ --auth https://id.altudohackathon.localhost/ --allow-write true
if ($LASTEXITCODE -ne 0) {
...
Start-Process https://cm.altudohackathon.localhost/sitecore/
Start-Process https://www.altudohackathon.localhost/
