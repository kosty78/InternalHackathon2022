...
try {
    ...
    & $mkcert -install
    & $mkcert "*.altudohackathon.localhost"
...
Add-HostsEntry "cm.altudohackathon.localhost"
Add-HostsEntry "cd.altudohackathon.localhost"
Add-HostsEntry "id.altudohackathon.localhost"
Add-HostsEntry "www.altudohackathon.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.altudohackathon.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.altudohackathon.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.altudohackathon.localhost"
